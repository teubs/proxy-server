...
INIT_CERTBOT_PATH="$HOME/Repositories/proxy-server/certbot-renew.sh"
...
CRON_ENTRY="* * * * * PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin; /bin/bash $INIT_CERTBOT_PATH >> /var/log/renew-certbot.log 2>&1"
